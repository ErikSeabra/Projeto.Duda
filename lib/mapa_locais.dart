...
class mapaLocais extends StatefulWidget {
  const mapaLocais({Key? key}) : super(key: key);

  @override
  State<mapaLocais> createState() => _mapaLocaisState();
}
        ...
        FloatingActionButton(onPressed: (){
          if (anonimo) {
              showDialog(
                ...
                content: Text("Os locais só podem ser inseridos por usuários cadastrados. \n\nDeseja se cadastrar agora?"),
                actions: [
                  TextButton(
